    ...
    <div className="bg-white max-h-[100dvh] flex-1 h-full p-6 flex flex-col items-center justify-start">
      ...
      <div className="grid mt-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full px-4 md:px-0">
        {recipes.map((recipe) => (
          ...
          >
            <img
              src={recipe.url ? recipe.url : 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
              alt={recipe.name}
      ...
      {selectedRecipe && (
        <div className="fixed inset-0 flex justify-center items-center z-50">
          <div className="bg-white w-[90%] md:w-[600px] rounded-xl shadow-lg max-h-[90vh] overflow-y-auto">
            <img
              src={selectedRecipe.url ? selectedRecipe.url : 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
