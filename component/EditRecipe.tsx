...
const EditRecipe: React.FC = () => {
  ...
  return (
    <div className="bg-white max-h-[100dvh] flex-1 h-full overflow-hidden p-6 flex flex-col items-center justify-start">
      ...
      <div className="flex-1 w-screen h-full overflow-y-auto px-4 md:px-0">
        {recipes.map((recipe) => (
          <div
            key={recipe._id}
                  ...
                  {selectedRecipe?.difficulties.map((diff, idx) => (
                    <div key={idx} className="flex gap-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          const updatedDiff =
                            selectedRecipe.difficulties.filter(
                              (d) => d !== diff
                            );
                          setSelectedRecipe({
                            ...selectedRecipe,
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-col gap-2">
                  {selectedRecipe?.ingredients.map((ing, idx) => (
                    <div
                      key={ing.id}
                      className="flex gap-2 flex-col items-start text-black"
                    >
                      <input
                        type="text"
