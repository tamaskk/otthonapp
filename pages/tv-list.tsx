...
const TvList = () => {
  const list: {channel: number, name: string, type: ChannelType}[] = [
    ...
    { channel: 151, name: 'Spieler 1 TV HD', type: ChannelType.Szórakoztató },
    { channel: 152, name: 'Sport 1 HD', type: ChannelType.Sport },
    { channel: 153, name: 'Spieler 2 TV HD', type: ChannelType.Szórakoztató },
    ...
    { channel: 205, name: 'NotGeo Wide HD', type: ChannelType.Ismeretterjesztő },
    { channel: 206, name: 'NotGeo HD', type: ChannelType.Ismeretterjesztő },
    ...
    { channel: 215, name: 'iD HD', type: ChannelType.Ismeretterjesztő },
    { channel: 216, name: 'History HD', type: ChannelType.Ismeretterjesztő },
    { channel: 217, name: 'Ozon TV HD', type: ChannelType.Szórakoztató },
